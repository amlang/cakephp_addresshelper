...
AddressHelper loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/amlang/cakephp_addresshelper/tree/gh-pages)
...
YourPlugin tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test View/Helper/AddressHelperTest.php

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./View/Helper/AddressHelper
...
* [Bug tracker](https://github.com/amlang/cakephp_addresshelper/issues)
